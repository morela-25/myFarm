...
<div>
    <h4 style="float: left;">Dairy data</h4> 
...
$result = mysqli_query($conn,"SELECT * FROM dairy");
?>
...
?>
        <tr>
            ...
            <td id="col1"><?php echo $row["CowID"]; ?></td>
            <td id="col2"><?php echo $row["Lactation"]; ?></td>
            <td id="col3"><?php echo $row["FTam"]; ?></td>
            <td id="col4"><?php echo $row["FQam"]; ?></td>
            <td id="col5"><?php echo $row["MQam"]; ?></td>
            <td id="col6"><?php echo $row["FTpm"]; ?></td>
            <td id="col7"><?php echo $row["FQpm"]; ?></td>
            <td id="col8"><?php echo $row["MQpm"]; ?></td>
            <td id="col9"><?php echo $row["TM"]; ?></td>
            <td id="col10"><?php echo $row["Infection"]; ?></td>
            <td id="col10"><?php echo $row["Treatment"]; ?></td>            
            <td id="col11"><?php echo $row["TimStamp"]; ?></td>
        </tr>
        <?php
$i++;
}
...
<script type="text/javascript">
        ...
        function downloadCSVFile(csv_data) {
            ...
            // Download csv file
            temp_link.download = "Dairy data.csv";
