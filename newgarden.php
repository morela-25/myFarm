...
<div>
    <h4 style="float: left;">Field data entry</h4> 
...
<form method="post" action="+field.php" enctype="multipart/form-data">
 ...
 <table id="emptbl">
        ...
        <tr>
            <td id="col0"><input type="text"  name="crop"></td>
            <td id="col1"><input type="text"  name="cyc"></td>
            <td id="col2"><input type="text"  name="stage"></td>
            <td id="col3"><input type="text"  name="H"></td>
            <td id="col4"><input type="text"  name="day"></td>
            <td id="col5"><input type="text"  name="nutr"></td>
            <td id="col6"><input type="text"  name="method"></td>
            <td id="col7"><input type="text"  name="moist"></td>
            <td id="col8"><input type="text"  name="ill"></td>
            <td id="col9"><input type="text"  name="chem"></td>
            <td id="col10"><input type="text"  name="date"></td>
        </tr>
        
    </table>
   
   <div style="margin-top: 10px;" align="left"><p><label>Name:</label>                            
<input type="text" name="user" style="width: 20%;"></p>
<p><label>E.C :</label>
<input type="number" name="ec" style="width: 10%; margin-left: 1%;"></p>
</div>


<div align="right"><textarea placeholder="Type issues here..." name="iss" style="width:55%"></textarea>
</div>

<button id="submit" style="padding: 5px; background: #03c04a; color:white; border: 2px solid #03c04a; border-radius: 5px; font-size: 11px;"><b>SUBMIT RECORDS</b></button>
                           <br><br><br>
  <?php  
