...
<div>
    <h4 style="float: left;">Piggery data amendment</h4> 
    <br>
     <form method="post" action="delPG.php" enctype="multipart/form-data">
...
<form method="post" action="pgup.php" enctype="multipart/form-data">
</div><br><br>
 <table id="emptbl">
