...
<div>
    <h4 style="float: left;">Poultery data</h4> 
...
$result = mysqli_query($conn,"SELECT * FROM poultryy");
?>
...
?>
        <tr>
            ...
            <td id="col1"><?php echo $row["cls"]; ?></td>
            <td id="col2"><?php echo $row["tc"]; ?></td>
            ...
            <td id="col9"><?php echo $row["treat"]; ?></td> 
            <td id="col10"><?php echo $row["Deaths"]; ?></td>            
...
<script type="text/javascript">
        ...
        function downloadCSVFile(csv_data) {
            ...
            // Download csv file
            temp_link.download = "Poultery data.csv";
