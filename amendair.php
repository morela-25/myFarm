...
<div>
    <h4 style="float: left;">Dairy data amendment</h4> 
    <br>
    <form method="post" action="delDA.php" enctype="multipart/form-data">
...
<form method="post" action="dairup.php" enctype="multipart/form-data">
</div><br><br>
 <table id="emptbl">
        ...
        <tr>
            <td id="col0"><input type="number"  name="index"></td>
              <td id="col1"><input type="text"  name="cow"></td>
            <td id="col2"><input type="text"  name="lac"></td>
            <td id="col3"><input type="text"  name="ftyp"></td>
            <td id="col4"><input type="text"  name="fqty"></td>
            <td id="col5"><input type="text"  name="mlk"></td>
            <td id="col6"><input type="text"  name="feedtyp"></td>
            <td id="col7"><input type="text"  name="feedqty"></td>
            <td id="col8"><input type="text"  name="mlkqty"></td>
            <td id="col9"><input type="text"  name="tot"></td>
            <td id="col10"><input type="text"  name="inf"></td>
            <td id="col11"><input type="text" name="trt"></td>
        </tr>
