...
<div>
    <h4 style="float: left;">Piggery data</h4> 
...
$result = mysqli_query($conn,"SELECT * FROM piggery");
?>
...
?>
        <tr>
            ...
            <td id="col1"><?php echo $row["pgCls"]; ?></td>
            <td id="col2"><?php echo $row["TP"]; ?></td>
            <td id="col3"><?php echo $row["Devstage"]; ?></td>
            <td id="col4"><?php echo $row["FTam"]; ?></td>
            <td id="col5"><?php echo $row["FQam"]; ?></td>
            <td id="col6"><?php echo $row["FTpm"]; ?></td>
            <td id="col7"><?php echo $row["FQpm"]; ?></td>
            <td id="col8"><?php echo $row["Infection"]; ?></td>
            <td id="col9"><?php echo $row["VertC"]; ?></td>           
            <td id="col10"><?php echo $row["TimeStamp"]; ?></td>
        </tr>
        <?php 
$i++;
}
...
<script type="text/javascript">
        ...
        function downloadCSVFile(csv_data) {
            ...
            // Download csv file
            temp_link.download = "Piggery data.csv";
