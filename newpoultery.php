...
<div>
    <h4 style="float: left;">Poultery data entry</h4> 
...
<form method="post" action="+pltry.php" enctype="multipart/form-data">
</div><br><br>
 <table id="emptbl">
   ...
   <div style="margin-top: 10px; font-size: 11px;" align="left"><p><label>Name:</label>                            
<input type="text" name="user" style="width: 20%; font-size: 11;"></p>
<p><label>E.C :</label>
<input type="number" name="ec" style="width: 10%; margin-left: 1%;"></p>
</div>
<div align="right"><textarea name="iss" placeholder="Type issues here..." style="width:55%"></textarea>
</div>
