...
<div>
    <h4 style="float: left;">Field crop data amendment</h4> 
    <br><form method="post" action="delG.php" enctype="multipart/form-data">
    <div style="width: 15%;"> <p> <input type="number" name="index" id="index" style="width:38%;"> Enter data endex</p><button id="delete" name="delete" style=" padding: 5px; background: red; color:white; border: 2px solid red; border-radius: 5px; font-size: 10px; float: left;"><b>Delete entry</b></button>
 </div>
...
<form method="post" action="gup.php" enctype="multipart/form-data">
</div><br><br>
 <table id="emptbl">
