...
<div>
    <h4 style="float: left;">Dairy data entry</h4> 
...
<form method="post" action="+dairy.php" enctype="multipart/form-data">
</div><br><br>
...
<div align="right"><textarea name="iss" placeholder="Type issues here..." style="width:55%"></textarea>
 ...
 <button id="submit" name="submit" style="padding: 5px; background: #03c04a; color:white; border: 2px solid #03c04a; border-radius: 5px; font-size: 11px;"><b>SUBMIT RECORDS</b></button> 
